...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Table Lokasi</h6>
        </div>
        <div class="card-body">
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="/lokasiinsert" method="POST">
                <?= csrf_field(); ?>
                <div class="modal-body">
                    <div class="mb-2">
                        <label for="id_lokasi">ID Lokasi</label>
                        <input type="text" id="id_lokasi" name="id_lokasi" readonly class="form-control" value="<?= $new_id; ?>">
                    </div>
                    <div class="mb-2">
