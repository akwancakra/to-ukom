...
<div class="container-fluid">
        ...
        <div class="search">
            <form action="" method="GET">
                ...
                <div class="input-group my-3">
                    ...
                    <input type="text" class="form-control" placeholder="Search Data..." aria-label="peminjam"
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Table Pinjam Barang</h6>
        </div>
        <div class="card-body">
                            ...
                            <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $dat['id_pinjam']; ?></td>
                                        <td><?= $dat['peminjam']; ?></td>
                                        <td><?= $dat['tgl_pinjam']; ?></td>
                                        <td><?= $dat['barang_pinjam']; ?></td>
                                        <td><?= $dat['jml_pinjam']; ?></td>
                                        ...
                                        <td class="d-flex">
                                            ...
                                            <a href="/pinjambarang/edit/<?= $dat['id_pinjam']; ?>"
        ...
        <div>
            <?= $pager->links('pinjam', 'custom_pagination') ?>
        </div>
    </div>
</div>
<!-- Modal -->
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="/pinjambarang/insert" method="POST">
                <?= csrf_field(); ?>
                <div class="modal-body">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="number" id="jml_pinjam" name="jml_pinjam" class="form-control">
                    </div>
                    <!-- <div class="mb-2">
